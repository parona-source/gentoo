...
if [[ "${PV}" == "9999" ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/${KODI_GH_ORG}"
else
...
# @FUNCTION: kodi-addon-r1_src_configure
# @DESCRIPTION:
# Configure handling for Kodi addons
kodi-addon-r1_src_configure() {
...
# @FUNCTION: kodi-addon-r1_src_prepare
# @DESCRIPTION:
# Prepare handling for Kodi addons
kodi-addon-r1_src_prepare() {
