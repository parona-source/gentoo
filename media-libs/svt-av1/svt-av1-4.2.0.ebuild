...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-4.2.0-tests.patch
	"${FILESDIR}"/${PN}-4.2.0-system-gtest.patch
)
...
src_prepare() {
	...
	rm -r third_party/{aom/inc,googletest} || die
	...
	# Tries to download stuff for this test and needs a fork of libaom
